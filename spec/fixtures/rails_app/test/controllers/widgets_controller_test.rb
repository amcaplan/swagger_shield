...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { metadata: @widget.metadata, name: @widget.name, price: @widget.price, tags: @widget.tags } }, as: :json
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { metadata: @widget.metadata, name: @widget.name, price: @widget.price, tags: @widget.tags } }, as: :json
    assert_response 200
  end
